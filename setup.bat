...
"%VENV_PY%" -m pip install "gradio>=4.44" "PyMuPDF>=1.24" "ebooklib>=0.18" "beautifulsoup4>=4.12" "lxml>=5.0" "python-docx>=1.1" "soundfile>=0.12" "numpy>=1.26" "num2words>=0.5.10" "pyttsx3>=2.90" "segno>=1.6" "pyinstaller>=6.10"
if errorlevel 1 goto :fail
